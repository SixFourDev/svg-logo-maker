...
describe('Shape Testing Suite', () => {
    ...
    // Describe block for the Square class
    describe('Square', () => {
        // Test case for the Square class - include message of what should pass
        it('Square render method returns correct SVG string', () => {
            // Create an instance with a new square with the color 'green'
            const square = new Square('green');
            // Expected svg string for a green square
            const expectedSvg = '<rect x="0" y="0" width="100" height="100" fill="green" />';
            // Use render method of the square instance that hsould be equal to expectedSvg
